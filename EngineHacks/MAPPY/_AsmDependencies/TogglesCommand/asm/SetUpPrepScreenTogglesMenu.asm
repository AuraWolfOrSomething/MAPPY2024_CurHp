...
.global SetUpPrepScreenTogglesMenu
.type SetUpPrepScreenTogglesMenu, %function


		SetUpPrepScreenTogglesMenu:
		push	{r4-r5,r14}
		add		sp, #-0x04
		mov		r4, r0
		mov		r1, #1
		...
		ldr		r5, =PrepScreenTogglesMapMenuList
		...
		ldr		r0, =TransitionFromTogglesMenuToPrepScreenMenu
		...
		@ldr		r0, =PrepScreenProc_InitMapMenu
		@ldr		r0, =TransitionFromTogglesMenuToPrepScreenMenu
		mov		r0, #0

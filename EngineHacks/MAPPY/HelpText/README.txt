...
This assembly edits that mechanic so that other types of helptext can be more easily created. When those new types are being viewed, suitable labels and values can also be displayed. Due to both the size of this assembly and its contents mostly being optional inclusions, the installation process is done over several files instead of all of it being contained within this file.
